...
// checks if the CreateGroupServiceAccountRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupServiceAccountRequestDataAttributes{}

// CreateGroupServiceAccountRequestDataAttributes struct for CreateGroupServiceAccountRequestDataAttributes
type CreateGroupServiceAccountRequestDataAttributes struct {
...
type _CreateGroupServiceAccountRequestDataAttributes CreateGroupServiceAccountRequestDataAttributes
...
func NewCreateGroupServiceAccountRequestDataAttributes(authType string, name string, roleId string) *CreateGroupServiceAccountRequestDataAttributes {
	this := CreateGroupServiceAccountRequestDataAttributes{}
...
func (o CreateGroupServiceAccountRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o CreateGroupServiceAccountRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGroupServiceAccountRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGroupServiceAccountRequestDataAttributes := _CreateGroupServiceAccountRequestDataAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGroupServiceAccountRequestDataAttributes)

	if err != nil {
		return err
	}

	*o = CreateGroupServiceAccountRequestDataAttributes(varCreateGroupServiceAccountRequestDataAttributes)

	return err
}

type NullableCreateGroupServiceAccountRequestDataAttributes struct {
	value *CreateGroupServiceAccountRequestDataAttributes
	isSet bool
}

func (v NullableCreateGroupServiceAccountRequestDataAttributes) Get() *CreateGroupServiceAccountRequestDataAttributes {
	return v.value
}

func (v *NullableCreateGroupServiceAccountRequestDataAttributes) Set(val *CreateGroupServiceAccountRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGroupServiceAccountRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGroupServiceAccountRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGroupServiceAccountRequestDataAttributes(val *CreateGroupServiceAccountRequestDataAttributes) *NullableCreateGroupServiceAccountRequestDataAttributes {
	return &NullableCreateGroupServiceAccountRequestDataAttributes{value: val, isSet: true}
}

func (v NullableCreateGroupServiceAccountRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGroupServiceAccountRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
