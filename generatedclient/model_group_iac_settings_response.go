...
// checks if the GroupIacSettingsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupIacSettingsResponse{}
...
func (o *GroupIacSettingsResponse) GetAttributes() GroupIacSettingsResponseAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GroupIacSettingsResponseAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GroupIacSettingsResponseAttributes and assigns it to the Attributes field.
...
func (o GroupIacSettingsResponse) MarshalJSON() ([]byte, error) {
...
func (o GroupIacSettingsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGroupIacSettingsResponse struct {
	value *GroupIacSettingsResponse
	isSet bool
}

func (v NullableGroupIacSettingsResponse) Get() *GroupIacSettingsResponse {
	return v.value
}

func (v *NullableGroupIacSettingsResponse) Set(val *GroupIacSettingsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupIacSettingsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupIacSettingsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupIacSettingsResponse(val *GroupIacSettingsResponse) *NullableGroupIacSettingsResponse {
	return &NullableGroupIacSettingsResponse{value: val, isSet: true}
}

func (v NullableGroupIacSettingsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupIacSettingsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
