...
// checks if the CommonIssueModelAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonIssueModelAttributes{}

// CommonIssueModelAttributes struct for CommonIssueModelAttributes
...
func NewCommonIssueModelAttributes() *CommonIssueModelAttributes {
	this := CommonIssueModelAttributes{}
	return &this
}
...
func (o CommonIssueModelAttributes) MarshalJSON() ([]byte, error) {
...
func (o CommonIssueModelAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableCommonIssueModelAttributes struct {
	value *CommonIssueModelAttributes
	isSet bool
}

func (v NullableCommonIssueModelAttributes) Get() *CommonIssueModelAttributes {
	return v.value
}

func (v *NullableCommonIssueModelAttributes) Set(val *CommonIssueModelAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonIssueModelAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonIssueModelAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonIssueModelAttributes(val *CommonIssueModelAttributes) *NullableCommonIssueModelAttributes {
	return &NullableCommonIssueModelAttributes{value: val, isSet: true}
}

func (v NullableCommonIssueModelAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonIssueModelAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
