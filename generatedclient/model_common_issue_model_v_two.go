...
// checks if the CommonIssueModelVTwo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonIssueModelVTwo{}

// CommonIssueModelVTwo struct for CommonIssueModelVTwo
...
func (o *CommonIssueModelVTwo) GetAttributes() CommonIssueModelVTwoAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret CommonIssueModelVTwoAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given CommonIssueModelVTwoAttributes and assigns it to the Attributes field.
...
func (o CommonIssueModelVTwo) MarshalJSON() ([]byte, error) {
...
func (o CommonIssueModelVTwo) ToMap() (map[string]interface{}, error) {
...
type NullableCommonIssueModelVTwo struct {
	value *CommonIssueModelVTwo
	isSet bool
}

func (v NullableCommonIssueModelVTwo) Get() *CommonIssueModelVTwo {
	return v.value
}

func (v *NullableCommonIssueModelVTwo) Set(val *CommonIssueModelVTwo) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonIssueModelVTwo) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonIssueModelVTwo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonIssueModelVTwo(val *CommonIssueModelVTwo) *NullableCommonIssueModelVTwo {
	return &NullableCommonIssueModelVTwo{value: val, isSet: true}
}

func (v NullableCommonIssueModelVTwo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonIssueModelVTwo) UnmarshalJSON(src []byte) error {
	v.isSet = true
